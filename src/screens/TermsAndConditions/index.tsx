...
const TermsAndConditions = () => {
  ...
  const scrollToRef = useCallback((ref: RefObject<HTMLAnchorElement>) => {
    window.scrollTo({ top: (ref.current?.offsetTop ?? 0) - parseInt(theme.spacing(12) || '0', 10),  behavior: 'smooth' });
  }, [theme]);
  return (
      ...
      <SectionBox main>
        <SectionLimit>
          ...
          <ContentBox className="termsandconditions__content">
            <Trans i18nKey='terms-and-conditions:content' components={{
              b: <strong/>,
              br: <br/>,
              p: <Typography/>,
